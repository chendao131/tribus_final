<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%><%@ taglib prefix="c"  uri="http://java.sun.com/jsp/jstl/core" %><html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title></title>
<style>
body{
...
<div class="container" align="center">
    ...
    <table width="201" height="68" border="0px;"  cellpadding="0px" cellspacing="0px">
    	<tr style="border:0px;"> 				
            ...
            <input type="text" name="username" type="required" id="textfield" 
        ...
        <tr style="border:0px;"> 				
            ...
            <img src="../images/login and easy register dialog (2).png" width="230" height="32"></div>
            <div class="userAndPassword" style="float:left">
            <input type="text" name="pwd" id="pwd" type="email" style="border-color: transparent; " value="password" />
            </div>
            </div></td>       	
        </tr>
