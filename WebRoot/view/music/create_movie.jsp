	...
	<div id="wrapper"><!--start wrapper-->
        ...
        <div id="main_area"><!--start main_area-->
                        ...
                        <div id="persoanal_form"><!--start persoanal_form-->
                        	...
                        	<form action="" id="movie_edit_form">
                            	...
                            	<div class="persoanal_inp_field">
                                    ...
                                    <p><input type="text" value="${movie.movieNameOriginal }" name="musicName"/></p>
                                </div>
                             	<div class="persoanal_inp_field">
                                	<label>Singer:</label>
                                    <p><input type="text" value="${movie.singer.singerName }" name="musicSinger"/></p>
                                </div>
                                <div class="persoanal_inp_field">
                                	<label>Release Date:</label>
                                    <p><input type="text" value="${movie.movieDate}" id="musicDate" name="musicDate"/></p>
                                </div>
                                ...
                                <div class="btn_save"><a href="javascript: saveMusicCreation('${my_domain }/music/saveMusicCreation.action');">Save</a></div>
                            </form>
            ...
            <script type="text/javascript">
	            function saveMusicCreation(path){
