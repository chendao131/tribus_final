                ...
                <div id="review_lftcol"><!--start review_lftcol-->
                    ...
                    <div id="brief_main"><!--start brief_main-->
                        ...
                        <div class="just_watch"><!--start just_watch-->
                        	<h5>Just watched :</h5>
                            <ul>
                            	<li><img src="${my_local}/movie/img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="${my_local}/movie/img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="${my_local}/movie/img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="${my_local}/movie/img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="${my_local}/movie/img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                        ...
                        <div class="movie_img"><!--start movie_img-->
                            ...
                            <ul id="slider1"><li>
                            	<img src="${my_local}/movie/img/pic_kings1.jpg" alt="" width="124" height="81" />
                                <img src="${my_local}/movie/img/pic_kings2.jpg" alt="" width="124" height="81" />
                                <img src="${my_local}/movie/img/pic_kings3.jpg" alt="" width="124" height="82" />
                                <img src="${my_local}/movie/img/pic_kings4.jpg" alt="" width="124" height="82" />
                                <img src="${my_local}/movie/img/pic_kings5.jpg" alt="" width="79" height="83" />
                                <div class="clear"></div>
                                </li></ul>
                            </div>
                        </div><!--//end .movie_img-->
                        <div class="video_box"><!--start video_box-->
                        	...
                        	<div class="video_box_cont"><!--start video_box_cont-->
                            	<div class="btn_play"><a href="#"><img src="${my_local}/movie/img/btn_play.jpg" alt="" width="18" height="18" /></a></div>
                            	<img src="${my_local}/movie/img/pic_kings6.jpg" alt="" width="185" height="121"/>
                                <div class="play_side">
                        ...
                        <div class="video_box"><!--start video_box-->
                        	<div class="video_box_cont"><!--start video_box_cont-->
                            	<div class="btn_play"><a href="#"><img src="${my_local}/movie/img/btn_play.jpg" alt="" width="18" height="18" /></a></div>
                            	<img src="${my_local}/movie/img/pic_kings7.jpg" alt="" width="186" height="102"  />
                                <div class="play_side">
