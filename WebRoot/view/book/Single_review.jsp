...
<body>
                        ...
                        <div class="games_info"><!--start games_info-->
                        	...
                        	<div class="games_social">
                                ...
                                <div class="games_media">
                                	<div id='fb-root'></div>
                                	<a onclick='postToFeed(); return false;'><img src="${my_local}/book/img/icon_facebook2.jpg" alt="" width="15" height="15" /></a>
                                    <a id='msg'></a>
	...
	<script type="text/javascript">
      ...
      function postToFeed() {
        ...
        var obj = {
          method: 'feed',
          link: '${my_domain}/review/bookReview/${singleReviewMain.itemId}.action',
