...
.container{	     
	 position:relative;	
	 height:625px;
	 background:url(images/wel_back.jpg);
	 width:619px;
...
<div class="container" align="center">
    ...
    <table width="201" height="68" border="0px;"  cellpadding="0px" cellspacing="0px">
        ...
        <tr style="border:0px;"> 				
            ...
            <img src="images/login and easy register dialog (2).png" width="230" height="32"></div>
            <div class="userAndPassword" style="float:left">
            <input type="text" name="textfield" id="pwd" style="border-color: transparent; " value="password"  on>
            </div>
            </div></td>       	
        </tr>
		...
		<tr style="border:0px;"> 				
            ...
            <div style="float:left">
            <img src="images/login and easy register dialog (2).png" width="230" height="32"></div>
            <div class="userAndPassword" style="float:left"><input type="text" name="textfield" id="textfield" style="border-color: transparent; " value="password"></div>
            </div></td>       	
        </tr>
		...
		<tr style="border:0px;"> 				
            ...
            <img src="images/login and easy register dialog (2).png" width="230" height="32"></div>
            <div class="userAndPassword" style="float:left">
            <input type="text" name="textfield" id="textfield" style="border-color: transparent; " value="password"></div>
            </div></td>       	
        </tr>
    ...
    <br />
    <a href="#"><img src="images/enter.jpg" /></a>    
    <br />
