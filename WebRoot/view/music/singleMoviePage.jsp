...
<body>
            ...
            <div id="header_rgt"><!--start header_rgt-->
            	<div id="menu_bg"><div id="menu_lft"><div id="menu_rgt">
                    <ul>
                        ...
                        <li><a href="${my_local}/book/bookHomePage.action" title="BOOK">BOOK</a></li>
                        <li><a href="${my_local}/music/musicHomePage.action" title="MUSIC">MUSIC</a></li>
                        <li><a href="${my_local}/my.action" title="MY TRIBUS">MY TRIBUS</a></li>
                    </ul>
                    ...
                    <div id="brief_main"><!--start brief_main-->
                        ...
                        <div id="kings_reivew">
                            ...
                            <div class="review_box"><!--start review_box-->
                                ...
                                <div class="review_title_area"><!--start review_title_area-->
                                    <div class="review_small_img">
                                        <a href="${my_local }/friendHome/${thisReview.userId }.action"><img src="${thisReview.userPic}" alt="" width="31" height="30" /></a>
                                        <a href="#"><img src="${domain}movie/img/black_arrow.jpg" alt="" width="9" height="16" /></a>
                                    </div>
                                ...
                                <div class="rating_feature"><!--strat rating_feature-->
                                    ...
                                    <div class="rating_star">
                                        <div class="rating_star_lft">
                                            <a href="#"><img src="${domain}movie/img/icon_star1.png" alt="" width="12" height="12" /></a>
                                            <a href="#"><img src="${domain}movie/img/icon_star1.png" alt="" width="12" height="12" /></a>
                                            <a href="#"><img src="${domain}movie/img/icon_star1.png" alt="" width="12" height="12" /></a>
                                            <a href="#"><img src="${domain}movie/img/icon_star1.png" alt="" width="12" height="12" /></a>
                                            <a href="#"><img src="${domain}movie/img/icon_star2.png" alt="" width="12" height="12" /></a>
                                        </div>
                                        <div class="rating_star_rt"><a href="${my_local }/review/movieReview/${thisReview.commentId }.action"><img src="${domain}movie/img/tripple_arrow4.png" alt="" width="27" height="9" /></a></div>
                                    </div>
                            ...
                            <div class="review_box"><!--start review_box-->
                                <div class="review_title_area"><!--start review_title_area-->
                                    <div class="review_small_img">
                                        <a href="${my_local}/friendHome/${thisReview.userId }.action"><img src="${thisReview.userPic}" alt="" width="31" height="31" /></a>
                                        <a href="#"><img src="${domain}movie/img/black_arrow.jpg" alt="" width="9" height="16" /></a>
                                    </div>
                                    <div class="review_title_rgt">
                                        <h3><a href="{my_local }/review/movieReview/${thisReview.commentId }.action"><c:out value="${thisReview.commentTitle}" /></a></h3>
    ...
    <script src="${my_local }/movie/js/init.js" type="text/javascript"></script>
