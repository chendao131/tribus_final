...
<body>
	<div id="wrapper"><!--start wrapper-->
    	<div id="header"><!--start header-->
    		...
    		<div class="logo"><a name="top" href="my/{user.userId}.action"><img src="${domain }user/img/logo.png" alt="" width="59" height="65" /></a></div>        
            <div id="header_rgt"><!--start header_rgt-->
            	<div id="menu_bg"><div id="menu_lft"><div id="menu_rgt">
                    <ul>
                        ...
                        <li class="current_page_item"><a href="myTribus.action" title="MY TRIBUS">MY TRIBUS</a></li>
                    </ul>
                        ...
                        <div class="friend_common_box"><!--start friend_common_box-->
                        	<div class="friend_box_bg"><div class="friend_box_top"><div class="friend_box_btm">
                                ...
                                <c:forEach items="${activity}" var="it" varStatus="in">
                                	...
                                	<img class="activity_valley1" src="${in.activityPic }" alt="" width="68" height="67" />                                                                   	
                                	</c:if>
                                	
                                	<c:if test="${in.index <4 && in.index >0}">
                                	<img src="${in.activityPic }" alt="" width="67" height="67" />                                                                                                        	
                                	</c:if>
                                	                                	
                                	<c:if test="${in.index == 4}">                                	 
                                    <img class="activity_valley2" src="${in.activityPic }" alt="" width="70" height="67" />                                	
                                	</c:if>                                	
                                </c:forEach>
