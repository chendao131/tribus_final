...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen,projection" href="${no_view_url}review/css/css3.css" />
    <!--[if lt IE 10]>
...
<body>
            	...
            	<div id="review_main"><!--start review_main-->
                	<div id="review_lftcol"><!--start review_lftcol-->
                        ...
                        <div class="review_post"><!--start review_post-->
                            <div class="review_ratting space_rating"><!--start review_ratting-->
                            	<img src="${no_view_url}review/img/pic_review.jpg" alt="" class="pic_review" width="44" height="43" />
                        ...
                        <div class="games_info"><!--start games_info-->
                        	<div class="games_btm_icon"><img src="${no_view_url}review/img/icon_album.jpg" alt="" width="20" height="19"/></div>
                        	<div class="games_social">
                            	<span>By <c:out value="${singleReviewMain.userName}" /></span>
                                <div class="games_media">
                                	<a href="#"><img src="${no_view_url}review/img/icon_facebook2.jpg" alt="" width="15" height="15" /></a>
                                    <a href="#"><img src="${no_view_url}review/img/icon_tweet2.jpg" alt="" width="16" height="15" /></a>
                                    <a href="#">+ Wish List</a>
                        ...
                        <div id="comment_box_area"><!--start comment_box_area-->
                        	...
                        	<div class="comment_box"><!--start comment_box-->
                            	...
                            	<div class="comment_first_content"><!--start comment_first_content-->
                                	<div class="pic_author">
                                        ...
                                        <img src="${no_view_url}review/img/pic_author1.png" alt="" width="73" height="73" />
                                    </div>
                                    <div class="author_total_rgt">
                                        ...
                                        <div class="author_icon">
                                        	<span><img src="${no_view_url}review/img/icon_album.jpg" alt="" width="20" height="19" /></span>
                            ...
                            <div class="comment_box bg_differ"><!--start comment_box-->
                            	<div class="comment_scnd_content"><!--start comment_scnd_content-->
                                	<div class="pic_author">
                                        <img src="${no_view_url}review/img/pic_author2.png" alt="" width="72" height="72" />
                                    </div>
                                    <div class="author_total_rgt">
                                    	<div class="author_speech">
                    ...
                    <div id="review_side_bar"><!--start review_side_bar-->
                    	...
                    	<div class="review_feature">
                            ...
                            <h3><c:out value="${singleReviewMain.itemName}" /> Page <a href="#"><img src="${no_view_url}review/img/tripple_arrow3.jpg" alt="" /></a></h3>
                        </div>
                        <div class="rating_widget">
                        	<h2>Seach by Rating <span>(<a href="#"><c:out value="${singleReviewMain.commentNumber}" /></a>)</span></h2>
                            <ul>
                            	<li>
                                	<a href="#"><img src="${no_view_url}review/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${no_view_url}review/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${no_view_url}review/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${no_view_url}review/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${no_view_url}review/img/icon_rating1.jpg" alt="" /></a>
                                ...
                                <li>
                                    ...
                                    <a href="#"><img src="${no_view_url}review/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${no_view_url}review/img/icon_rating1.jpg" alt="" /></a>
                                    <a href="#"><img src="${no_view_url}review/img/icon_rating2.jpg" alt="" /></a>
    ...
    <script src="${no_view_url}review/js/jquery-1.js" type="text/javascript"></script>
    <script src="${no_view_url}review/js/easy-editable-text.js" type="text/javascript"></script>
