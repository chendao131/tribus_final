...
<body>
                ...
                <div id="review_lftcol"><!--start review_lftcol-->
                        ...
                        <div id="product_twocol"><!--start product_twocol-->
                            ...
                            <div id="product_rgtcol"><!--start product_rgtcol-->
                            	<div class="kings_rating">
                                    ...
                                    <a href="#"><img src="${my_local}/book/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
                                    <a href="#"><img src="${my_local}/book/img/icon_ratting.jpg" alt="" width="20" height="19" /></a>
                                    <a href="#"><img src="${my_local}/book/img/icon_ratting2.jpg" alt="" width="20" height="19" /></a>
                                </div>
                                <ul class="kings_list">
                    ...
                    <div id="brief_main"><!--start brief_main-->
                        ...
                        <div class="just_watch"><!--start just_watch-->
                        	<h5>Just watched :</h5>
                            <ul>
                            	<li><img src="${my_local}/book/img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="${my_local}/book/img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="${my_local}/book/img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="${my_local}/book/img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                                <li><img src="${my_local}/book/img/pic_review_small_1.jpg" alt="" width="31" height="30" /><span> Name<small>........</small>4mins ago</span></li>
                            	...
                            	<div class="slider">
                                	<div class="sliderContent">
                                            ...
                                            <div class="kings_gallery">
                                                <img src="${my_local}/book/img/pic_kings1.jpg" alt="" width="124" height="81" />
                                                <img src="${my_local}/book/img/pic_kings2.jpg" alt="" width="124" height="81" />
                                                <img src="${my_local}/book/img/pic_kings3.jpg" alt="" width="124" height="82" />
                                                <img src="${my_local}/book/img/pic_kings4.jpg" alt="" width="124" height="82" />
                                                <img src="${my_local}/book/img/pic_kings5.jpg" alt="" width="79" height="83" />
                                            </div>
                                        </div>
                                        <div class="item">
                                            <div class="kings_gallery">
                        ...
                        <div class="video_box"><!--start video_box-->
                        	...
                        	<div class="video_box_cont"><!--start video_box_cont-->
                            	<div class="btn_play"><a href="#"><img src="${my_local}/book/img/btn_play.jpg" alt="" width="18" height="18" /></a></div>
                            	<img src="${my_local}/book/img/pic_kings6.jpg" alt="" width="185" height="121"/>
                                <div class="play_side">
                        ...
                        <div class="video_box"><!--start video_box-->
                        	<div class="video_box_cont"><!--start video_box_cont-->
                            	<div class="btn_play"><a href="#"><img src="${my_local}/book/img/btn_play.jpg" alt="" width="18" height="18" /></a></div>
                            	<img src="${my_local}/book/img/pic_kings7.jpg" alt="" width="186" height="102"  />
                                <div class="play_side">
	...
	<script src="${my_local }/book/js/mobilyslider.js" type="text/javascript"></script>
    <script src="${my_local }/book/js/init.js" type="text/javascript"></script>
