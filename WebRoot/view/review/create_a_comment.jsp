...
<body>
	<div id="wrapper"><!--start wrapper-->
        ...
        <div id="main_area"><!--start main_area-->
            	...
            	<div id="album_content" class="create_list"><!--start album_content-->
                    <div id="gallery"><!--start gallery-->
                        ...
                        <div id="create_comment"><!--start create_comment-->
                        	<input type="text" class="creat_comment_txt" />
                            <textarea class="message_comment" rows="10" cols="10"></textarea>
			...
			<script src="${my_local }/review/js/jquery.min.js" type="text/javascript"></script>
            <script src="${my_local }/review/js/jquery.raty.js" type="text/javascript"></script>
